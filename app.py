...
# 100% Working & Stable Live Models Only
model_name = st.sidebar.selectbox(
    "Active Neural Engine",
    [
        "gemini-2.0-flash",         # Best & Fastest Stable Production Engine
        "gemini-1.5-pro",           # Deep Reasoning & Long-Context Specialist
        "gemini-1.5-flash",         # Reliable Lightweight Engine
    ],
    index=0
)
...
st.sidebar.markdown("---")
st.sidebar.info("🚀 **Omni Super App v6.7**\nOptimized with Stable Live Models.")
