...
# --- साइडबार: सारे एडवांस कंट्रोल्स और चारों मुख्य मॉडल्स ---
with st.sidebar:
  st.markdown("### ⚙️ AI Studio Control Hub")

  # 1. मॉडल सिलेक्शन (यहाँ gemini-1.5-flash सहित चारों मॉडल्स पूरी तरह मौजूद हैं)
  selected_model = st.selectbox(
      ...
      help=(
          "अपनी जरूरत के अनुसार 2.5 Flash, 1.5 Pro, 2.0 Flash या 1.5 Flash चुनें।"
      ),
  )
