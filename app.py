...
# Error-Free & Stable Model Selector
model_name = st.sidebar.selectbox(
    "Active Neural Engine",
    [
        "gemini-2.5-flash",         # Fast High-Volume Execution & Multi-modal Workhorse
        "gemini-2.5-pro",           # Deep Advanced Reasoning & Enterprise Analytics
...
if prompt := st.chat_input("Command your Omni-App (e.g., 'Generate image of a sunset', 'Book Porter delivery', 'Show daily summary')..."):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            # --- ROUTE 1: VIDEO GENERATION (Veo / Cinematic Engine) ---
            ...
            # --- ROUTE 2: IMAGE GENERATION (Gemini Image / Visual Engine) ---
                ...
                # Fallback text representation or image output handling
...
st.sidebar.markdown("---")
st.sidebar.info("🚀 **Omni Super App v6.2**\nFully Secured with Streamlit Secrets & Stable Gemini Models.")
