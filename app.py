...
# --- साइडबार: सारे एडवांस कंट्रोल्स और स्टेबल मॉडल्स ---
with st.sidebar:
  st.markdown("### ⚙️ AI Studio Control Hub")

  # 1. मॉडल सिलेक्शन (केवल 100% वर्किंग और स्टेबल मॉडल्स)
  selected_model = st.selectbox(
      "मॉडल चुनें (Model Engine):",
      ["gemini-2.0-flash", "gemini-1.5-pro"],
      help="Gemini 2.0 Flash और 1.5 Pro पूरी तरह से स्टेबल और एक्टिव हैं।",
  )
  ...
  temperature = st.slider(
      ...
      value=0.7,
      step=0.05,
      help="0.0 = सटीक और तार्किक; 1.0 = अत्यधिक रचनात्मक।",
  )
  ...
  if user_input := st.chat_input("अपना मैसेज या कोडिंग सवाल यहाँ पूछें..."):
    ...
    with st.chat_message("assistant"):
      with st.spinner("AI गहन विचार कर रहा है..."):
        models_to_try = [selected_model, "gemini-2.0-flash", "gemini-1.5-pro"]
